...
## Install
If you just want to use @saxx/fca-unofficial, you should use this command:
```bash
npm install @saxx/fca-unofficial
```
It will download `@saxx/fca-unofficial` from NPM repositories
...
## Example Usage
```javascript
const login = require("@saxx/fca-unofficial");
